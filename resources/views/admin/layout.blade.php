...
<head>
    ...
    <link rel="shortcut icon" href="{{URL::asset('img/tuandesa.ico')}}" type="image/x-icon">
    ...
    <link rel="stylesheet"
        href="{{URL::asset('vendor/adminlte/plugins/overlayScrollbars/css/OverlayScrollbars.min.css')}}">
...
<body class="hold-transition sidebar-mini layout-fixed" style="height: auto;">
    ...
    <script src="{{URL::asset('vendor/adminlte/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')}}">
    </script>
    <script>
