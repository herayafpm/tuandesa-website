...
@section('headTitle',__('admin.dataaduans'))
@push('css')
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{__('admin.dataaduans')}}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">{{__('admin.dataaduans')}}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card p-2">
                <div class="card-header">
                  @can('add_aduans')
                  <div><a class="btn btn-primary" href="{{url('admin/aduans/create')}}">Add New</a></div>
                  @endcan
                  <div class="card-tools">
                    <div class="input-group input-group-sm">
                      {!! Form::open(['url' => route('aduans.index'), 'method' => 'GET']) !!}
                        <div class="row">
                          <div class="col">
                    ...
                    <tbody>
                      @forelse ($aduans as $aduan)
                        <tr>
                          ...
                          @can('edit_aduans', 'delete_aduans')
                          <td class="row w-100">
                          <a class="btn btn-primary btn-sm mr-1" href="{{url('admin/aduans/'.$aduan->id.'/edit')}}" role="button">
                            <i class="fa fa-fw fa-pen" aria-hidden="true"></i>
                            Edit</a>
                          {!! Form::open(['url' => 'admin/aduans/'.$aduan->id,'class'=> 'delete']) !!}
              ...
              <div class="card-footer">
                {{$aduans->appends(request()->input())->links()}}
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
